...
describe Item do
  describe '#create' do
    ...
    it "is invalid without a shipping_cost" do
      item = Item.new(name: "a", description: "a", condition: 1, price: 123, category_id: 1, shipping_cost: "", prefecture_id: 3, shipping_day: 1, seller_id: 1 )
      item.valid?
      expect(item.errors[:shipping_cost]).to include("を入力してください")
    end

    it "is invalid without a prefecture_id" do
      item = Item.new(name: "a", description: "a", condition: 1, price: 123, category_id: 1, shipping_cost: 1, prefecture_id: "", shipping_day: 1, seller_id: 1 )
      item.valid?
      expect(item.errors[:prefecture_id]).to include("を入力してください")
    end

    it "is invalid without a shipping_day" do
      item = Item.new(name: "a", description: "a", condition: 1, price: 123, category_id: 1, shipping_cost: 1, prefecture_id: 1, shipping_day: "", seller_id: 1 )
      item.valid?
